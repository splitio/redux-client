 ...
 */
export declare function mapIsFeatureOnToProps(splitName: string, key?: SplitIO.SplitKey, getSplitState?: IGetSplitState): (state: any) => {
    isFeatureOn: boolean;
};
/**
 ...
 * @param {IGetSplitState} getSplitState function that extract the Split piece of state from the Redux state.
 */
export declare function mapTreatmentToProps(splitName: string, key?: SplitIO.SplitKey, getSplitState?: IGetSplitState): (state: any) => {
    feature: string;
};
/**
 *
